	...
	if (ibv_query_device(context,&attr)) {
		...
		*/
		...
		switch (attr.vendor_part_id) {
			...
			case 0x3404 : dev_fname = NBL_LEONIS; break; /* leonis snic v3r1 pf */
			case 0x3405 : dev_fname = NBL_LEONIS; break; /* leonis snic v3r1 pf */
			case 0x3406 : dev_fname = NBL_LEONIS; break; /* leonis snic v3r1 pf */
			case 0x3407 : dev_fname = NBL_LEONIS; break; /* leonis snic v3r1 pf */
			case 0x3408 : dev_fname = NBL_LEONIS; break; /* leonis snic v3r1 pf */
			case 0x3409 : dev_fname = NBL_LEONIS; break; /* leonis snic v3r1 pf */
			case 0x340A : dev_fname = NBL_LEONIS; break; /* leonis snic v3r1 pf */
			case 0x340B : dev_fname = NBL_LEONIS; break; /* leonis snic v3r1 pf */
			case 0x340C : dev_fname = NBL_LEONIS; break; /* leonis snic v3r1 pf */
			case 0x340D : dev_fname = NBL_LEONIS; break; /* leonis snic v3r1 pf */
			case 0x340E : dev_fname = NBL_LEONIS; break; /* leonis snic v3r1 pf */
			case 0x340F : dev_fname = NBL_LEONIS; break; /* leonis snic v3r1 pf */
			case 0x3410 : dev_fname = NBL_LEONIS; break; /* leonis snic v3r1 pf */
			case 0x3411 : dev_fname = NBL_LEONIS; break; /* leonis snic v3r1 pf */
			case 0x3412 : dev_fname = NBL_LEONIS; break; /* leonis snic v3r1 pf */
			...
			case 0x3501 : dev_fname = NBL_DRACO; break; /* DRACO pf */
			case 0x3502 : dev_fname = NBL_DRACO; break; /* DRACO pf */
			case 0x3503 : dev_fname = NBL_DRACO; break; /* DRACO pf */
			case 0x3504 : dev_fname = NBL_DRACO; break; /* DRACO pf */
			case 0x3505 : dev_fname = NBL_DRACO; break; /* DRACO pf */
			case 0x3506 : dev_fname = NBL_DRACO; break; /* DRACO pf */
			case 0x3507 : dev_fname = NBL_DRACO; break; /* DRACO pf */
			case 0x3508 : dev_fname = NBL_DRACO; break; /* DRACO pf */
			case 0x3509 : dev_fname = NBL_DRACO; break; /* DRACO pf */
